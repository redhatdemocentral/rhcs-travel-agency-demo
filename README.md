...
Log in to JBoss Travel Agency to start exploring an online bookings application (the address will be generated by the init script):
  ...
  - OCP example: http://rhcs-travel-agency-demo-appdev-in-cloud.192.168.99.100.nip.io/business-central ( u:erics / p:bpmsuite1! )

  - OCP example web app: http://rhcs-travel-agency-demo-appdev-in-cloud.192.168.99.100.nip.io/external-client-ui-form-1.0
